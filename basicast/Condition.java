...
public class Condition extends Expression
{
    ...
    /**
     * Method list prints out the condition in the format:
     * 
     *      e1 op e2
     * 
     * where e1 and e2 are the two expressions and op is the relational operator.
     * 
     * @postcondition the condition has been printed to standard output with the above
     *                formatting
     */
    public void list()
    {
