...
public class BinOp extends Expression
{
    ...
    /**
     * Method list prints out the binary operation in the format:
     * 
     *      exp1 op exp2
     * 
     * where exp1 and exp2 are the two expressions and op is the operator.
     * 
     * @postcondition the binary operation has been printed to standard output with the above
     *                formatting
     */
    public void list()
    {
